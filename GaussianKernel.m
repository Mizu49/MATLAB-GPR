classdef GaussianKernel < handle
    ...
    methods (Access = public)
        function obj = GaussianKernel(initdesignparams)
        ...
        function kernelvalue = kernel(obj, x1, x2, idx1, idx2)
            ...
            kernelvalue = p1*exp(-L(x1, x2)/p2) + p3 * deltafun(idx1, idx2);
        end
        ...
        function grad = grad1(obj, x1, x2, idx1, idx2)
            ...
            grad = obj.kernel(x1, x2, idx1, idx2) - p3*deltafun(idx1, idx2);
        end
        ...
        function grad = grad2(obj, x1, x2, idx1, idx2)
            ...
            % norm^2
            L = @(x1, x2) (x1 - x2)' * (x1 - x2) ;
            grad = (obj.kernel(x1, x2, idx1, idx2) - p3*deltafun(idx1, idx2))*exp(-obj.designparams(1,2))*L(x1, x2);
        end

        function grad = grad3(obj, x1, x2, idx1, idx2)
            grad = obj.hyperparams(1,3) * deltafun(idx1, idx2);
        end
    end
